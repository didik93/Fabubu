...
* **🎁 免费简单**：完全免费，界面简洁直观，交互流畅，致力于提供最纯粹的用户体验。
...
1. **添加账号**：
    * 打开 Fabubu，进入“账号管理”。
    * 点击右上角“添加账号”，选择对应平台（如抖音、B站、小红书等）。
    * 在弹出的浏览器窗口中扫码登录，登录成功后窗口会自动关闭，账号即添加完成。
...
3. **查看状态**：
    * 发布任务会自动进入后台队列，您可以在界面下方查看实时进度和日志。

## 🤝 贡献与反馈

Fabubu 是一个开源项目，我们欢迎社区的每一份贡献！

* **反馈 Bug**：请提交 [GitHub Issues](https://github.com/AIKnightPanda/Fabubu/issues)。
